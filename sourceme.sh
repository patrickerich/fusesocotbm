...
# Use more recent gcc version
source /opt/rh/gcc-toolset-13/enable
# Add library path var for compiling certain packages
export LIBRARY_PATH=/usr/lib/gcc/x86_64-redhat-linux/11
...
# Add variable needed for running cocotb
